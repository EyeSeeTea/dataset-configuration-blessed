...
const webpackConfig = {
    ...
    devServer: {
        ...
        proxy: [
            ...
            { path: "/css/*", target: "http://localhost:8082/build", bypass: log },
            { path: "/i18n/*", target: "http://localhost:8082/src", bypass: log },
            {
                path: "/jquery.min.js",
                target: "http://localhost:8082/node_modules/jquery/dist",
                bypass: log,
            },
            {
                path: "/polyfill.min.js",
                target: "http://localhost:8082/node_modules/babel-polyfill/dist",
                bypass: log,
            },
        ],
    },
